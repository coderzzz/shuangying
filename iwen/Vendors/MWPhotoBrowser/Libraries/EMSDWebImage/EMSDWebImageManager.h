...
typedef void(^EmsSDWebImageCompletedWithFinishedBlock)(UIImage *image, NSError *error, EMSDImageCacheType cacheType, BOOL finished) __deprecated_msg("Block type deprecated. Use `EMSDWebImageCompletionWithFinishedBlock`");
...
- (id <EMSDWebImageOperation>)downloadWithURL:(NSURL *)url
                                    options:(EMSDWebImageOptions)options
                                   progress:(EMSDWebImageDownloaderProgressBlock)progressBlock
                                  completed:(EmsSDWebImageCompletedWithFinishedBlock)completedBlock __deprecated_msg("Method deprecated. Use `downloadImageWithURL:options:progress:completed:`");
